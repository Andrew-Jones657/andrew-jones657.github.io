...
<p> The big caveat to the Google Takeout data is that it is in a proprietary JSON format.  To use it in ArcGIS Pro, some adjustments will need to be made to standardize the data. </p> <br>
